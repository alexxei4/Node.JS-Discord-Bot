...
module.exports = {
        ...
        async execute(interaction){
          ...
          const result = await axios.get(`https://x-colors.herokuapp.com/api/rgb2hsl?value=${red}-${green}-${blue}`);
          console.log(result);
          return interaction.reply("Here is the colour in HSL Code: "+result.data.hsl);
        }
